//Quote displayer
 class Quote extends React.Component {
    ...
    render(){
        return(
            <div className="transition" id="text">
...
class Tweetbutton extends React.Component {
    ...
    render(){
        return(
            <a id="tweet-quote" href="https://twitter.com/intent/tweet" target="_blank"><i className="fa fa-twitter-square"></i></a>
        );
    }
}
...
class Component extends React.Component {
    ...
    handleClick(){
        ...
        $("#quote-box").css("background",this.state.css_background);
        $("#new-quote").css({"color":this.state.css_background, "outline-color": this.state.css_background});
    }
